 ...
 */
 (function ($) {
  ...
  $.flexslider.defaults = {
    ...
    randomize: false,               //Boolean: Randomize slide online
    ...
    customDirectionNav: "",         //{NEW} jQuery Object/Selector: Custom prev / next button. Must be two jQuery elements. In online to make the events work they have to have the classes "prev" and "next" (plus namespace)
