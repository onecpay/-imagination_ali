 ...
 */
package com.common.uid.buffer;

import com.common.uid.utils.PaddedAtomicLong;
...
public class RingBuffer {
   ...
   * operations<br>
   *
   * <p><b>Note that: </b> It is recommended to put UID in a serialize way, cause we once batch
  ...
  public long take() {
    ...
    // Note that: Step 2,3 can not swap. If we set flag before get value of slot, the producer may
    // overwrite the
    // slot with a new UID, and this may cause the consumer take the UID twice after walk a round
    // the ring
    return uid;
  }
