...
public class MyUtils {
    ...
    private static final Pattern SLUG_REGEX = Pattern
            .compile("^[A-Za-z0-9_-]{5,100}$", Pattern.CASE_INSENSITIVE);
        ...
        if (null != request) {
            ...
            if (cookie != null && cookie.getValue() != null) {
                try {
                    ...
                    return StringUtils.isNotBlank(uid) && Tools.isNumber(uid) ? Integer.valueOf(uid)
                            : null;
                } catch (Exception e) {
    ...
    public static DataSource getNewDataSource() {
        ...
        try {
            if (dataSource == null) {
                Properties properties = MyUtils
                        .getPropFromFile("classpath:application-jdbc.properties");
...
//            }
//            return UUID.UU32() + "." + (ext == null ? null : (ext));
//        }
//    }
