 ...
 */
@Api(value = "微信公众号菜单栏的配置",tags = "微信菜单配置")
@AllArgsConstructor
@RestController
...
public class WxMenuController {
     ...
     */
    @ApiOperation(value = "create",notes = "创建微信菜单栏")
    @PostMapping("/create")
...
////        button2.setPagePath("pages/lunar/manage.html");
...
//    }
    ...
    public static void main(String[] args) {
        WxMenu menu = new WxMenu();
//        WxMenuButton button1 = new WxMenuButton();
//        button1.setName("小样视界");

        WxMenuButton button11 = new WxMenuButton();
        button11.setType(MenuButtonType.VIEW);
        button11.setName("视界官网");
        button11.setUrl("http://imagination.seejoke.com/wechat/common/manage/center");

        WxMenuButton button12 = new WxMenuButton();
        button12.setType(MenuButtonType.VIEW);
        button12.setName("视界中心");
        button12.setUrl("http://imagination.seejoke.com/wechat/common/center/manage");

        menu.getButtons().add(button11);
        menu.getButtons().add(button12);
//        WxMenuButton button13 = new WxMenuButton();
//        button13.setType(MenuButtonType.VIEW);
//        button13.setName("APP下载");
//        button13.setUrl("http://344192ef.ngrok.io/wechat/");
//
...
//
//        WxMenuButton button2 = new WxMenuButton();
//        button2.setName("获取商户");
//
//        WxMenuButton button21 = new WxMenuButton();
//        button21.setType(MenuButtonType.VIEW);
//        button21.setName("微信商户");
//        button21.setUrl("http://8afb7c17.ngrok.io/wechat/2222");
//
//        WxMenuButton button22 = new WxMenuButton();
//        button22.setType(MenuButtonType.VIEW);
//        button22.setName("支付宝");
//        button22.setUrl("http://8afb7c17.ngrok.io/wechat/2222");
//
...
//        button31.setKey("service");
//
//        WxMenuButton button32 = new WxMenuButton();
//        button32.setType(MenuButtonType.VIEW);
//        button32.setName("专属客服");
//        button32.setUrl("http://8afb7c17.ngrok.io/wechat/");
//
//        WxMenuButton button33 = new WxMenuButton();
//        button33.setType(MenuButtonType.VIEW);
//        button33.setName("个人中心");
//        button33.setUrl("http://8afb7c17.ngrok.io/wechat/");
//
//        button3.getSubButtons().add(button31);
//        button3.getSubButtons().add(button32);
//        button3.getSubButtons().add(button33);
